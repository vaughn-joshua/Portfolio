...
import SideNav, { SECTION_NAV_ITEMS } from "./SideNav";
...
function Sidebar({ active }: { active: string }) {
  ...
  // Identity + action buttons. Reused as the burger panel header on mobile so
  // the whole sidebar lives in the menu there.
  const identity = (
  ...
  return (
    <aside className="left">
      {/* Mobile-only: the entire sidebar collapses into this menu. */}
      <BurgerNav
      ...
      {/* Desktop sticky column (hidden on mobile via CSS). */}
      <div>
        {identity}
